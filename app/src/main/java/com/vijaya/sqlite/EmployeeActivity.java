...
public class EmployeeActivity extends AppCompatActivity {
    ...
    // button for search and update functionality
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteButton = findViewById(R.id.deleteEmployee);
        updateButton = findViewById(R.id.updateEmployee);
        deleteButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(binding.firstnameEditText.toString().equals("")){
                    binding.firstnameEditText.setError("Enter Name");
                }
                else{
                    deleteEmployee(binding.firstnameEditText.toString());
                }
            }
        });
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(binding.firstnameEditText.toString().equals("")){
                    ...
                    // update the employee having this name
                    updateEmployee(binding.firstnameEditText.toString());
    ...
    private void updateEmployee(String toString) {
    }
